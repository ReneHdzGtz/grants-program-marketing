...
description: >
  ...
  Use this skill whenever the user asks about launching or improving a grants program,
  attracting quality applicants to a DAO or protocol grants round, reviewing grant
  applications, communicating grant results, or building the marketing strategy for
  a grants ecosystem.
  Also trigger for phrases like "our grants program", "attract builders to apply",
  "grant application review", "communicate grants", "grants V2/V3", "grantee spotlight",
  "grants page copy", "how to market a hackathon", or any variation of funding program
  management in Web3, DeFi, DAO, or protocol contexts.
---
